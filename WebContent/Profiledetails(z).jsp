...
<body>
	...
	<table>
		...
		<tr>
			...
			%>
			<th><%=f.getFollowed().getUsername()%></th>
			<th><a href="fol-profile.jsp?id=<%=f.getFollowed().getuId()%>">
					profile</a></th>
			<th><a href="fol-playlist.jsp?id=<%=f.getFollowed().getuId()%>">
					playlist</a></th>
			<th><a
	...
	<table>
		...
		<tr>
			...
			%>
			<th><%=f.getFollow().getUsername()%></th>
			<th><a href="fol-profile.jsp?id=<%=f.getFollow().getuId()%>">
					profile</a></th>
			<th><a href="fol-playlist.jsp?id=<%=f.getFollow().getuId()%>">
					playlist</a></th>
			<%
				}
			%>
	...
	<table>
		...
		<tr>
			<th>title:<%=comment.getTitle()%></th>
		</tr>
		<tr>
			<th>content:<%=comment.getContent()%></th>
		</tr>
		<%
			}
			}
